 ...
 */
#include <omnetpp.h>
#include "CTSGenerator30.h"  // Include the header file

using namespace omnetpp;

class client30 : public cSimpleModule {
private:
    int messageCount;
    int maxMessageCount;
...
void client30::handleMessage(cMessage *msg) {
...
void client30::sendNextMessage() {
    messageCount++;

    cMessage *msg = generateCTSMessage30();
    ...
    std::string encryptedMessage = "SM30:" + std::to_string(messageCount) + ":" + originalMessage;
...
void client30::handleDroppedMessage(cMessage *msg) {
