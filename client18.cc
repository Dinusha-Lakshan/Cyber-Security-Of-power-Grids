 ...
 */
#include <omnetpp.h>
#include "CTSGenerator18.h"  // Include the header file

using namespace omnetpp;

class client18 : public cSimpleModule {
private:
    int messageCount;
    int maxMessageCount;
...
void client18::handleMessage(cMessage *msg) {
...
void client18::sendNextMessage() {
    messageCount++;

    cMessage *msg = generateCTSMessage18();
    ...
    std::string encryptedMessage = "SM18:" + std::to_string(messageCount) + ":" + originalMessage;
...
void client18::handleDroppedMessage(cMessage *msg) {
