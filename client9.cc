 ...
 */
#include <omnetpp.h>
#include "CTSGenerator9.h"  // Include the header file

using namespace omnetpp;

class client9 : public cSimpleModule {
private:
    int messageCount;
    int maxMessageCount;
...
void client9::handleMessage(cMessage *msg) {
...
void client9::sendNextMessage() {
    messageCount++;

    cMessage *msg = generateCTSMessage9();
    ...
    std::string encryptedMessage = "SM9:" + std::to_string(messageCount) + ":" + originalMessage;
...
void client9::handleDroppedMessage(cMessage *msg) {
