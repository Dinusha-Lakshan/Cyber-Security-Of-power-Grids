 ...
 */
#include <omnetpp.h>
#include "CTSGenerator23.h"  // Include the header file

using namespace omnetpp;

class client23 : public cSimpleModule {
private:
    int messageCount;
    int maxMessageCount;
...
void client23::handleMessage(cMessage *msg) {
...
void client23::sendNextMessage() {
    messageCount++;

    cMessage *msg = generateCTSMessage23();
    ...
    std::string encryptedMessage = "SM23:" + std::to_string(messageCount) + ":" + originalMessage;
...
void client23::handleDroppedMessage(cMessage *msg) {
