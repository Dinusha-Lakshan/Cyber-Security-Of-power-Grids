 ...
 */
#include <omnetpp.h>
#include "CTSGenerator22.h"  // Include the header file

using namespace omnetpp;

class client22 : public cSimpleModule {
private:
    int messageCount;
    int maxMessageCount;
...
void client22::handleMessage(cMessage *msg) {
...
void client22::sendNextMessage() {
    messageCount++;

    cMessage *msg = generateCTSMessage22();
    ...
    std::string encryptedMessage = "SM22:" + std::to_string(messageCount) + ":" + originalMessage;
...
void client22::handleDroppedMessage(cMessage *msg) {
