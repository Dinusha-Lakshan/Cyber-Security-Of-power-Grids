 ...
 */
#include <omnetpp.h>
#include "CTSGenerator17.h"  // Include the header file

using namespace omnetpp;

class client17 : public cSimpleModule {
private:
    int messageCount;
    int maxMessageCount;
...
void client17::handleMessage(cMessage *msg) {
...
void client17::sendNextMessage() {
    messageCount++;

    cMessage *msg = generateCTSMessage17();
    ...
    std::string encryptedMessage = "SM17:" + std::to_string(messageCount) + ":" + originalMessage;
...
void client17::handleDroppedMessage(cMessage *msg) {
