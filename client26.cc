 ...
 */
#include <omnetpp.h>
#include "CTSGenerator26.h"  // Include the header file

using namespace omnetpp;

class client26 : public cSimpleModule {
private:
    int messageCount;
    int maxMessageCount;
...
void client26::handleMessage(cMessage *msg) {
...
void client26::sendNextMessage() {
    messageCount++;

    cMessage *msg = generateCTSMessage26();
    ...
    std::string encryptedMessage = "SM26:" + std::to_string(messageCount) + ":" + originalMessage;
...
void client26::handleDroppedMessage(cMessage *msg) {
