 ...
 */
#include <omnetpp.h>
#include "CTSGenerator16.h"  // Include the header file

using namespace omnetpp;

class client16 : public cSimpleModule {
private:
    int messageCount;
    int maxMessageCount;
...
void client16::handleMessage(cMessage *msg) {
...
void client16::sendNextMessage() {
    messageCount++;

    cMessage *msg = generateCTSMessage16();
    ...
    std::string encryptedMessage = "SM16:" + std::to_string(messageCount) + ":" + originalMessage;
...
void client16::handleDroppedMessage(cMessage *msg) {
