 ...
 */
#include <omnetpp.h>
#include "CTSGenerator29.h"  // Include the header file

using namespace omnetpp;

class client29 : public cSimpleModule {
private:
    int messageCount;
    int maxMessageCount;
...
void client29::handleMessage(cMessage *msg) {
...
void client29::sendNextMessage() {
    messageCount++;

    cMessage *msg = generateCTSMessage29();
    ...
    std::string encryptedMessage = "SM29:" + std::to_string(messageCount) + ":" + originalMessage;
...
void client29::handleDroppedMessage(cMessage *msg) {
