 ...
 */
#include <omnetpp.h>
#include "CTSGenerator21.h"  // Include the header file

using namespace omnetpp;

class client21 : public cSimpleModule {
private:
    int messageCount;
    int maxMessageCount;
...
void client21::handleMessage(cMessage *msg) {
...
void client21::sendNextMessage() {
    messageCount++;

    cMessage *msg = generateCTSMessage21();
    ...
    std::string encryptedMessage = "SM21:" + std::to_string(messageCount) + ":" + originalMessage;
...
void client21::handleDroppedMessage(cMessage *msg) {
