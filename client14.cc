 ...
 */
#include <omnetpp.h>
#include "CTSGenerator14.h"  // Include the header file

using namespace omnetpp;

class client14 : public cSimpleModule {
private:
    int messageCount;
    int maxMessageCount;
...
void client14::handleMessage(cMessage *msg) {
...
void client14::sendNextMessage() {
    messageCount++;

    cMessage *msg = generateCTSMessage14();
    ...
    std::string encryptedMessage = "SM14:" + std::to_string(messageCount) + ":" + originalMessage;
...
void client14::handleDroppedMessage(cMessage *msg) {
