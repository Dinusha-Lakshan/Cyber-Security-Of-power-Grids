 ...
 */
#include <omnetpp.h>
#include "CTSGenerator6.h"  // Include the header file

using namespace omnetpp;

class client6 : public cSimpleModule {
private:
    int messageCount;
    int maxMessageCount;
...
void client6::handleMessage(cMessage *msg) {
...
void client6::sendNextMessage() {
    messageCount++;

    cMessage *msg = generateCTSMessage6();
    ...
    std::string encryptedMessage = "SM6:" + std::to_string(messageCount) + ":" + originalMessage;
...
void client6::handleDroppedMessage(cMessage *msg) {
