 ...
 */
#include <omnetpp.h>
#include "CTSGenerator11.h"  // Include the header file

using namespace omnetpp;

class client11 : public cSimpleModule {
private:
    int messageCount;
    int maxMessageCount;
...
void client11::handleMessage(cMessage *msg) {
...
void client11::sendNextMessage() {
    messageCount++;

    cMessage *msg = generateCTSMessage11();
    ...
    std::string encryptedMessage = "SM11:" + std::to_string(messageCount) + ":" + originalMessage;
...
void client11::handleDroppedMessage(cMessage *msg) {
