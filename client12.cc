 ...
 */
#include <omnetpp.h>
#include "CTSGenerator12.h"  // Include the header file

using namespace omnetpp;

class client12 : public cSimpleModule {
private:
    int messageCount;
    int maxMessageCount;
...
void client12::handleMessage(cMessage *msg) {
...
void client12::sendNextMessage() {
    messageCount++;

    cMessage *msg = generateCTSMessage12();
    ...
    std::string encryptedMessage = "SM12:" + std::to_string(messageCount) + ":" + originalMessage;
    ...
    simtime_t interval = 0.1; // Interval of 2 seconds
    nextMessageTime += interval;
    scheduleAt(nextMessageTime, new cMessage("RTS"));
}

void client12::handleDroppedMessage(cMessage *msg) {
