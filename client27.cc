 ...
 */
#include <omnetpp.h>
#include "CTSGenerator27.h"  // Include the header file

using namespace omnetpp;

class client27 : public cSimpleModule {
private:
    int messageCount;
    int maxMessageCount;
...
void client27::handleMessage(cMessage *msg) {
...
void client27::sendNextMessage() {
    messageCount++;

    cMessage *msg = generateCTSMessage27();
    ...
    std::string encryptedMessage = "SM27:" + std::to_string(messageCount) + ":" + originalMessage;
...
void client27::handleDroppedMessage(cMessage *msg) {
