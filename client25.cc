 ...
 */
#include <omnetpp.h>
#include "CTSGenerator25.h"  // Include the header file

using namespace omnetpp;

class client25 : public cSimpleModule {
private:
    int messageCount;
    int maxMessageCount;
...
void client25::handleMessage(cMessage *msg) {
...
void client25::sendNextMessage() {
    messageCount++;

    cMessage *msg = generateCTSMessage25();
    ...
    std::string encryptedMessage = "SM25:" + std::to_string(messageCount) + ":" + originalMessage;
...
void client25::handleDroppedMessage(cMessage *msg) {
