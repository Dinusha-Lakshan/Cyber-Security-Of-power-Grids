 ...
 */
#include <omnetpp.h>
#include "CTSGenerator15.h"  // Include the header file

using namespace omnetpp;

class client15 : public cSimpleModule {
private:
    int messageCount;
    int maxMessageCount;
...
void client15::handleMessage(cMessage *msg) {
...
void client15::sendNextMessage() {
    messageCount++;

    cMessage *msg = generateCTSMessage15();
    ...
    std::string encryptedMessage = "SM15:" + std::to_string(messageCount) + ":" + originalMessage;
...
void client15::handleDroppedMessage(cMessage *msg) {
